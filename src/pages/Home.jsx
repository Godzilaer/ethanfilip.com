  ...
  return (
    <main className="container-fluid">
        ...
        <section className="w-100 mt-3">
            ...
            <p className="main-p fs-3">I am 15 years old in 9th grade at Dover-Sherborn High School in Massachusetts. I am most interested in technology, science, and engineering. I post some of my completed projects on this website along with my extracurriculars, hobbies, experiences, and awards.</p>
            <hr />
